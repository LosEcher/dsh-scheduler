...
var BTN_PRIMARY = { ...BTN, background: "var(--dsw-alias-brand-primary)", color: "var(--dsw-alias-label-primary-foreground)", borderColor: "transparent" };
var INPUT = {
  width: "100%",
...
var BADGE_OK = { ...BADGE, color: "var(--dsw-alias-state-success-primary)", borderColor: "color-mix(in srgb, var(--dsw-alias-state-success-primary) 33%, transparent)" };
var BADGE_BAD = { ...BADGE, color: "var(--dsw-alias-state-error-primary)", borderColor: "color-mix(in srgb, var(--dsw-alias-state-error-primary) 33%, transparent)" };
var MUTED = { color: "var(--dsw-alias-label-tertiary)", fontSize: 12 };
var TITLE = { margin: "0 0 8px", fontSize: 14, fontWeight: 600, color: "var(--dsw-alias-label-primary)" };
    ...
    showForm ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: CARD, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { onSubmit: (e) => void submitForm(e), style: { display: "grid", gap: 8 }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 12 }, children: [
          ...
          preview ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { ...MUTED, wordBreak: "break-all" }, children: preview.map(fmt).join(" \uFF5C ") }) : previewError ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "var(--dsw-alias-state-error-primary)" }, children: previewError }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: MUTED, children: "\u2026" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: ROW, children: [
    ...
    jobs.length === 0 && !loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: CARD, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: MUTED, children: "\u6682\u65E0\u5B9A\u65F6\u4EFB\u52A1\uFF0C\u70B9\u300C+ \u65B0\u5EFA\u4EFB\u52A1\u300D\u521B\u5EFA\u7B2C\u4E00\u4E2A\u3002" }) }) : jobs.map((job) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: CARD, children: [
        ...
        runsFor === job.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: 8, borderTop: "1px solid var(--dsw-alias-border-l2)", paddingTop: 8 }, children: runs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: MUTED, children: "\u6682\u65E0\u8FD0\u884C\u8BB0\u5F55" }) : runs.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { style: { marginBottom: 6, fontSize: 12 }, children: [
          ...
          r.error ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { style: { ...MUTED, color: "var(--dsw-alias-state-error-primary)", whiteSpace: "pre-wrap", margin: "4px 0" }, children: r.error }) : null,
