...
._eb44c5ac_scError { color: color-mix(in srgb, var(--dsw-alias-state-error-primary) 55%, var(--dsw-alias-label-primary)); font-size: 12px; margin-top: 6px; }
...
._5514676b_scTextarea { height: auto; padding: 6px 8px; }
...
._679ed996_scInput::placeholder, ._5514676b_scTextarea::placeholder { color: var(--dsw-alias-label-dimmed); }
._345516a9_scSelect {
  appearance: none;
...
._345516a9_scSelect option { color: var(--dsw-alias-label-primary); background: var(--dsw-alias-bg-layer-1); }
._5514676b_scTextarea { min-height: 72px; resize: vertical; }
._3948afda_scCheckbox { accent-color: var(--dsw-alias-brand-primary); }
...
._2e5f0482_scPreviewError { color: color-mix(in srgb, var(--dsw-alias-state-error-primary) 55%, var(--dsw-alias-label-primary)); }
...
._a2694e03_scBadgeDot { flex: none; }
...
._ba2089a0_scBadgeOk { background: var(--dsw-alias-state-success-tertiary); color: color-mix(in srgb, var(--dsw-alias-state-success-primary) 55%, var(--dsw-alias-label-primary)); border-color: var(--dsw-alias-state-success-secondary); }
._371f6a8c_scBadgeBad { background: color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1)); color: color-mix(in srgb, var(--dsw-alias-state-error-primary) 55%, var(--dsw-alias-label-primary)); }
...
._d0de20ba_scDangerText { color: color-mix(in srgb, var(--dsw-alias-state-error-primary) 55%, var(--dsw-alias-label-primary)); }
...
var SchedulerFooterAction_default = { "modalContent": "_145329e7_modalContent", "trigger": "_c7d08e09_trigger", "label": "_d304ba20_label", "badge": "_dcdd1274_badge", "modal": "_608ece08_modal" };
